...
```{r}
df_cross <- read.csv("../adn-2026/data/data2-cross_sectional.csv")
head(df_cross)
```
...
```{r}
df_long <- read.csv("../adn-2026/data/data2-panel_long.csv")
head(df_long)
```

```{r}
df_wide <- read.csv("../adn-2026/data/data2-panel_wide.csv")
head(df_wide)
```
