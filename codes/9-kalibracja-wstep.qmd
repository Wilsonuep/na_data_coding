...
```{python}
wynik_poprawny = np.array([52.275, 50.5821, 51.4286, 50.5462, 48.4301, 39.9657, 
...
```{python}
np.round(w1, 3)
np.round(wynik_poprawny, 3)
np.allclose(np.round(w1, 3), np.round(wynik_poprawny, 3))
```
...
```{python}
np.allclose(np.round(w2, 3), np.round(wynik_poprawny, 3))
```
